# Generated by Powerlevel10k configuration wizard on 2020-02-04 at 02:17 EST.
...
() {
  ...
  #
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    # '~/dev/ThorTech/ElectionAnalysisSystem(|/*)' ElectionAnalysisSystem 'EAS'
  )
  ...
  function my_git_formatter() {
    ...
    res+="${clean}${italics}${where//\%/%%}${italics_off}"  # escape %
    ...
    (( VCS_STATUS_NUM_UNTRACKED  )) && res+=" ${untracked}%B${POWERLEVEL9K_VCS_UNTRACKED_ICON}%b${grey}${VCS_STATUS_NUM_UNTRACKED}"
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#d08770' #178
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND='#ebcb8b' #180
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND='#ebcb8b' #180
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND='#8fbcbb'
  ...
  ############[ nodeenv: node.js environment (https://github.com/ekalinin/nodeenv) ]############
  # Nodeenv color.
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND='#a3be8c'
  ...
  ##############################[ node_version: node.js version ]###############################
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND='#a3be8c'
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      '*prod*'  PROD    # These values are examples that are unlikely
      # '*dev*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  ...
  typeset -g POWERLEVEL9K_AWS_PROD_FOREGROUND='#bf616a'
  typeset -g POWERLEVEL9K_AWS_PROD_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_AWS_PROD_CONTENT_EXPANSION='> ${P9K_CONTENT} <'

  #[ aws_eb_env: aws elastic beanstalk environment (https://aws.amazon.com/elasticbeanstalk/) ]#
  # AWS Elastic Beanstalk environment color.
  typeset -g POWERLEVEL9K_AWS_EB_ENV_FOREGROUND='#a3be8c'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_AZURE_FOREGROUND='#81a1c1'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_CLASSES=(
      ...
      # '*:*test*:*'  TEST    # to match your needs. Customize them as needed.
      '*'             DEFAULT)
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_DEFAULT_FOREGROUND='#81a1c1'
  ...
  typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND='#bf616a'
  # Show battery in green when it's charging or fully charged.
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND='#a3be8c'
